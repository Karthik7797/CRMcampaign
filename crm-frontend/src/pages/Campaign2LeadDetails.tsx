...
import { ArrowLeft, User, Mail, Phone, MapPin, Save, Edit2, Loader2, Send, MessageSquare, FileText, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button type="button" className="p-2 hover:bg-surface-700 text-slate-400 hover:text-white rounded-full transition-colors" onClick={() => navigate('/campaigns/2')}>
            <ArrowLeft size={20} />
          </button>
          <div>
