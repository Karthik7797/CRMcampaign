...
export default function Campaign1LeadDetails() {
  ...
  const { data: lead, isLoading, error } = useQuery({
    ...
    queryFn: () => campaign1Api.getOne(id!).then(r => r.data),
    enabled: !!id,
  })
  ...
  const updateMutation = useMutation({
    mutationFn: (data: any) => campaign1Api.update(id!, data),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['campaign-1-lead', id] })
  ...
  const addNoteMutation = useMutation({
    mutationFn: (content: string) => campaign1Api.addNote(id!, content),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['campaign-1-lead', id] })
      setNewNote('')
  ...
  if (error || !lead) {
    return (
      <div className="text-center mt-10">
        ...
        <Button type="button" variant="secondary" className="mt-4" onClick={() => navigate('/campaigns/1')}>Go Back</Button>
      </div>
    )
  }
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                {isEditing ? <Input id="collegeName" name="collegeName" value={formData.collegeName} onChange={handleChange} className="w-full" />
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                {isEditing ? <Input id="intake" name="intake" value={formData.intake} onChange={handleChange} className="w-full" />
              ...
              <div className="space-y-1.5">
                ...
                {isEditing ? <Input id="interestedCountry" name="interestedCountry" value={formData.interestedCountry} onChange={handleChange} className="w-full" />
