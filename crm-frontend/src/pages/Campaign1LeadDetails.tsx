  ...
  if (error || !lead) {
    return (
      <div className="text-center mt-10">
        ...
        <button type="button" className="btn-secondary mt-4" onClick={() => navigate('/campaigns/1')}>Go Back</button>
      </div>
    )
  }
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                {isEditing ? <input name="collegeName" value={formData.collegeName} onChange={handleChange} className="input w-full" />
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                {isEditing ? <input name="intake" value={formData.intake} onChange={handleChange} className="input w-full" />
              ...
              <div className="space-y-1.5">
                ...
                {isEditing ? <input name="interestedCountry" value={formData.interestedCountry} onChange={handleChange} className="input w-full" />
